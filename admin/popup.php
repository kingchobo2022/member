...
include '../inc/popup.php'; // 팝업 Class
...
?>         
    <tr>
      ...
      <td><?= $row['create_at']; ?></td>
      <td>
      <button class="btn btn-success btn-sm btn_popup_view" data-idx="<?= $row['idx']; ?>">보기</button>

        <button class="btn btn-primary btn-sm btn_popup_edit" data-bs-toggle="modal" data-bs-target="#popup_create_modal" data-idx="<?= $row['idx']; ?>">수정</button>
